	...
	<section id="bricks">
		<div class="container">
			...
			<div class="jumbotron">
				...
				<!-- 점보트론 버튼 -->
				<!-- Single button -->
				<div class="btn-group" id="btn_select">
		...
		<div class="row">
			...
			<nav class="pagination">
				<span class="page-numbers prev inactive">Prev</span> <span
					...
					href="#" class="page-numbers">4</a> <a href="#"
					class="page-numbers">5</a> <a href="#" class="page-numbers">6</a> <a
					href="#" class="page-numbers">7</a> <a href="#"
					class="page-numbers">8</a> <a href="#" class="page-numbers">9</a> <a
					href="#" class="page-numbers next">Next</a>
			</nav>
